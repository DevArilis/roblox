...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/DevArilis/roblox/main/Edits/PLS%20Donate%20Autofarm%20Edit.lua'))()")
...
local function update()
    ...
    if current > 999 then
        ...
        boothText = tostring('<stroke color="#ff002f" thickness="1"><font size="100"><font face="Bangers"><font color="#f2ff00">'.. text.. '</font></font></font></stroke>')
